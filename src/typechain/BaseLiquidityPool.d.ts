...
interface BaseLiquidityPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class BaseLiquidityPool extends BaseContract {
  ...
  interface: BaseLiquidityPoolInterface;
