...
interface PerpetualMarketCoreTesterInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setPoolSnapshot(int128,int128,uint128)": FunctionFragment;
    "setPoolStatus(uint256,int128,uint128)": FunctionFragment;
    ...
    "verifyCalculateFundingRate(uint256,int256,int256,int256,int256)": FunctionFragment;
    "verifyCalculateResultOfFundingPayment(uint256,int256,uint256)": FunctionFragment;
    "verifyCalculateSignedDeltaMargin(uint8,int256,int256)": FunctionFragment;
    "verifyCalculateUnlockedLiquidity(uint256,int256,int256)": FunctionFragment;
    "verifyExecuteFundingPayment(uint256,int256)": FunctionFragment;
    "verifyGetSignedMarginAmount(uint256)": FunctionFragment;
    "verifyUpdatePoolPositions(uint256,int256[2])": FunctionFragment;
    "verifyUpdateVariance(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setPoolSnapshot",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "verifyCalculateFundingRate",
    values: [
      BigNumberish,
      BigNumberish,
      BigNumberish,
  ...
  encodeFunctionData(
    functionFragment: "verifyCalculateResultOfFundingPayment",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "verifyCalculateSignedDeltaMargin",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "verifyCalculateUnlockedLiquidity",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "verifyExecuteFundingPayment",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "verifyGetSignedMarginAmount",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "verifyUpdatePoolPositions",
    values: [BigNumberish, [BigNumberish, BigNumberish]]
  ): string;
  encodeFunctionData(
    functionFragment: "verifyUpdateVariance",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class PerpetualMarketCoreTester extends BaseContract {
  ...
  interface: PerpetualMarketCoreTesterInterface;
  ...
  functions: {
    ...
    setPoolSnapshot(
      ...
      _ethVariance: BigNumberish,
      _lastSnapshotTime: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    setPoolStatus(
      _productId: BigNumberish,
      _positionPerpetuals: BigNumberish,
      _lastFundingPaymentTime: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    verifyCalculateFundingRate(
      _productId: BigNumberish,
      _margin: BigNumberish,
      _totalLiquidityAmount: BigNumberish,
      _deltaMargin: BigNumberish,
      _deltaLiquidity: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    verifyCalculateResultOfFundingPayment(
      _productId: BigNumberish,
    ...
    verifyCalculateSignedDeltaMargin(
      _marginChangeType: BigNumberish,
      _deltaMargin: BigNumberish,
      _currentMarginAmount: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    verifyCalculateUnlockedLiquidity(
      _amountLockedLiquidity: BigNumberish,
      _deltaM: BigNumberish,
      _hedgePositionValue: BigNumberish,
      overrides?: CallOverrides
    ): Promise<
      [BigNumber, BigNumber] & {
        deltaLiquidity: BigNumber;
        unlockLiquidityAmount: BigNumber;
      }
    >;

    verifyExecuteFundingPayment(
      _productId: BigNumberish,
      _spotPrice: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    verifyGetSignedMarginAmount(
      _productId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    verifyUpdatePoolPositions(
      _productId: BigNumberish,
      _tradeAmounts: [BigNumberish, BigNumberish],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    verifyUpdateVariance(
